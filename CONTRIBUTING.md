...
> If you want to ask a question, we assume that you have read the available [Documentation](https://docs.potassco.org/ngo/).
...
- Make sure that you are using the latest version.
- Read the [documentation](https://docs.potassco.org/ngo/) carefully and find out if the functionality is already covered, maybe by an individual configuration.
